	...
	<div class="hero-unit">
			<div class="tagline" >
				<h1>Vidiun Player ToolKit</h1>
				<p>Demos, Configuration Options and Tools for Creating Vidiun Player Experiences<p>
			</div>
	...
	<br>
	<br>
	<strong>The Vidiun Player</strong> leads the industry in <a href="#KeyFeatures" title="Key Features">flexibility</a>, 
	...
	We invite to explore the vast feature set of the Vidiun Player on your Tablets and Mobile Devices, 
	and use the HTML5 / Flash player switch tool present on almost all feature pages. 
	<br><br>
	<i>Note this site does not represent every feature available for the Vidiun player. </i>
	<br>
	<a name="HTML5"></a>
	<div class="blurb-left">
		<div class="blurb-img" >
			<a http://blog.vidiun.org/vidiun-html5-update-brings-new-features-and-best-in-class-performance" target="_blank">
		...
		You can extend the functionality of both Flash and HTML5
		 ...
		 Check out the <a href="http://html5video.org/wiki/Vidiun_Video_Library_Compatibility_Chart" target="_new">detailed feature chart</a>
	...
	<div class="blurb-right">
		...
		This, combined with Vidiun's <a href="autoEmbed">AutoEmbed</a> embed code, enables the player rendering to 
		...
		<br><br>
		This means you get 
		<a href="http://blog.vidiun.org/vidiun-html5-update-brings-new-features-and-best-in-class-performance" target="_blank">best in class performance</a> 
	...
	<div class="blurb-left">
		...
		<p>Vidiuns flexible player platform integrates with all the major Ad networks and Analytics providers.
		
		Vidiun supports a wide range of video ad formats including <a href="index.php?path=VastAdPods">VAST 3.0</a>, 
		...
		<a target="_blank" href="http://knowledge.vidiun.com/vidiun%E2%80%99s-generic-ads-player-plugin-vast">Ad Tech</a>, 
		<a target="_blank" href="http://knowledge.vidiun.com/vidiun%E2%80%99s-generic-ads-player-plugin-vast">Eye Wonder</a>, 
		<a target="_blank" href="http://knowledge.vidiun.com/faq/how-configure-adaptv-plugin">AdapTV</a>, 
		...
		<br><br>
		Every Vidiun account includes <a href="index.php?path=VidiunAnalytics">analytics fully integrated into the Vidiun platform</a>.
		Additionally Vidiun supports integrations with numerous analytics providers such as
		...
		<br><br>
		Vidiuns robust set of partners shortens time to market on integrating with your Ad and Anlytics partners.
	...
	<div class="blurb-right">
	<div class="blurb-img">
		<a title="studio" rel="lightbox[27]" href="http://central.vidiun.com/wp-content/uploads/2012/11/studio.png" class="cboxElement">
			<img class="shadow" title="studio" src="images/player.desing.jpg">
		</a>
	</div>
		<div class="blurb-txt" >
		<h2>Player Studio &amp; Templates</h2>
		<p>You can easily create customized cross browser/cross device players in the Vidiun player Studio from a variety of great looking, light-weight video player templates.</p>
	...
	<p>The VDP can be modified with the Studio, with the UIconf or with the API. See examples of how our customers have themselves (or in collaboration with Vidiun) made their player unique to their brand and business.</p>
	...
	<div class="blurb-right">
		<div class="blurb-img" style="margin-top:20px">
			<a title="studio" rel="lightbox[27]" href="http://site.vidiun.com/Vidiun_WhitePaper_Selecting_a_Video_Player_in_Todays_Digital_World_2015.html" class="cboxElement">
		...
		<h2>Vidiun Whitepaper: How to Select the Best Video Player</h2>
		...
		<BR><BR>
		<a href="http://site.vidiun.com/Select_the_Best_Video_Player.html">In this whitepaper</a> we will discuss the crucial questions to ask when looking for the right video platform 
