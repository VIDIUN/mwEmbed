				...
				'Playlists'=> array(
					...
					'testfiles' => array(
						...
						'playlistOnPage' => array(
							...
							'path' => '../vWidget/onPagePlugins/playlistOnPage/playlistOnPage.qunit.html'
						),
						...
						'PlaylistVertical' => array(
							...
							'path' => 'VidiunSupport/tests/PlaylistVertical.html'
						),
						'Carousel' => array(
							'title' => "Carousel",
							'path' => 'VidiunSupport/tests/Carousel.html'
						),
						'PlaylistNoClipList' => array(
							'title' => "Playlist No Clip List",
							'path' => 'VidiunSupport/tests/PlaylistNoClipList.html'
						),
						/*'PlaylistVidiunMRSS' => array(
							'title' => "Media RSS source",
							'path' => 'VidiunSupport/tests/PlaylistVidiunMRSS.html'
						),*/
						'PlaylistInitItemEntryId' => array(
							'title' => "Initial EntryId",
							'path' => 'VidiunSupport/tests/PlaylistInitItemEntryId.html'
						)
					)
				),
			)
			...
			'featureSets' => array(
				'Custom_Players' => array(
					...
					'testfiles' => array(
						...
						/*'CustomSkin' => array(
							'title' => 'Custom Skin',
							'path' => 'VidiunSupport/tests/CustomSkin.html'
						),
