( function( $ ) {
	...
	$.fn.loadingSpinner = function( opts ) {
		...
		if ((mw.getConfig("EmbedPlayer.EnableMobileSkin") && vWidget.isMobileDevice() && !options) || vWidget.isChromeCast() || (mw.getConfig("EmbedPlayer.EnableMobileSkin") && mw.getConfig("EmbedPlayer.SimulateMobile"))){
