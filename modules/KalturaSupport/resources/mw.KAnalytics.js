...
mw.VAnalytics.prototype = {
	...
	sendAnalyticsEvent: function( VidiunStatsEventKey ){
		var _this = this;
		// make sure we have a VS
		this.vClient.getVS( function( vs ){
			_this.doSendAnalyticsEvent( vs, VidiunStatsEventKey );
		});
	},
	doSendAnalyticsEvent: function( vs, VidiunStatsEventKey ){
		var _this = this;
		...
		// Do the api request:
		this.vClient.doRequest( eventRequest );
	},
