(function ( mw, $ ) {
    ...
    mw.DoubleClick.prototype = {
        ...
        addSkipSupport: function () {
            var _this = this;
            if ( this.embedPlayer.getRawVidiunConfig( 'skipBtn' ) && this.embedPlayer.getRawVidiunConfig( 'skipBtn', 'plugin' ) && this.embedPlayer.getVideoHolder().find( ".ad-skip-btn" ).length === 0 ) {
                var label = "Skip Ad";
        ...
        resumeSkipSupport: function () {
            if ( this.embedPlayer.getVidiunConfig( 'skipBtn', 'skipOffset' ) ) {
                ...
                this.startSkipTimeout( (this.embedPlayer.getVidiunConfig( 'skipBtn', 'skipOffset' ) * 1000) - timePassed );
            }
        },
        showSkipBtn: function () {
            if ( this.embedPlayer.getVidiunConfig( 'skipBtn', 'skipOffset' ) ) {
                $( ".ad-skip-label" ).show();
                this.startSkipTimeout( parseFloat( this.embedPlayer.getVidiunConfig( 'skipBtn', 'skipOffset' ) * 1000 ) );
            } else {
                $( ".ad-skip-btn" ).show();
                $( ".ad-skip-label" ).hide();
            }
