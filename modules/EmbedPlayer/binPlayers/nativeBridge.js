(function (mw, $) {
	...
	NativeBridge.videoPlayer = NativeBridge.videoPlayer || {
		...
		subscribed: [],
		playerMethods: [
			'stop', 'play', 'pause', 'replay', 'setPlayerSource', 'bindPlayerEvents', 'showNativePlayer', 'hideNativePlayer', 'toggleFullscreen', 'notifyVPlayerEvent', 'notifyVPlayerEvaluated', 'notifyJsReady', 'showChromecastDeviceList', 'sendCCRecieverMessage', 'notifyLayoutReady',
